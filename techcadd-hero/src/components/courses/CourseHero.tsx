        ...
        <div className="mt-8 grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          ...
          >
            ...
            {course.certification && (
              <span className="absolute -bottom-4 left-5 inline-flex items-center gap-2 rounded-2xl border border-white/15 bg-[#070c1c]/90 px-4 py-2.5 text-[12.5px] font-semibold text-white backdrop-blur-xl">
