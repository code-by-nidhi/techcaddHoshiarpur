    ...
    >
      ...
      <div className="shell text-center">
        ...
        >
          ...
          <button
            type="submit"
            className="rounded-full bg-[#050B1F] px-7 py-3.5 text-sm font-semibold text-white transition-shadow duration-300 hover:shadow-[0_18px_40px_-16px_rgb(255_255_255/0.6)]"
          >
            Book Demo
          </button>
