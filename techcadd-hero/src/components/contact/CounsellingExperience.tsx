          ...
          <div className="col-12 col-lg-5">
            ...
            >
              ...
              {BADGES.map(({ icon: Icon, label, place, delay }) => (
                ...
                >
                  <span className="grid size-8 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-[#2563EB] to-[#7C3AED] shadow-[0_10px_22px_-10px_rgba(37,99,235,0.9)]">
            ...
            >
                  ...
                  return (
                    <motion.button
                      ...
                      className={`rounded-full px-4 py-2 text-[13px] font-medium transition-colors duration-300 ${
                        on
                          ? "bg-gradient-to-r from-[#2563EB] to-[#7C3AED] text-white shadow-[0_0_28px_-6px_rgba(37,99,235,0.95)]"
              ...
              <ul className="mt-3 grid grid-cols-1 gap-2.5 sm:grid-cols-2 xl:grid-cols-3">
                {BENEFITS.map(({ icon: Icon, label }) => (
                  ...
                  >
                    <span className="grid size-7 shrink-0 place-items-center rounded-lg bg-gradient-to-br from-[#2563EB]/12 to-[#7C3AED]/12 ring-1 ring-inset ring-[#2563EB]/15">
              ...
              <motion.div
                ...
                className="relative mt-7 overflow-hidden rounded-[24px] bg-[linear-gradient(120deg,#1E3A8A_0%,#2563EB_45%,#7C3AED_100%)] p-6 text-center shadow-[0_26px_60px_-28px_rgba(37,99,235,0.95)] sm:p-7"
              >
                <motion.span
                  aria-hidden
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  transition={{ type: "spring", stiffness: 340, damping: 22 }}
                  className="group relative mt-5 inline-flex items-center gap-2.5 rounded-full bg-white px-7 py-3.5 text-[14.5px] font-semibold text-[#0F172A] shadow-[0_16px_40px_-14px_rgba(2,6,23,0.6)]"
                >
                  Book Free Session
                  <FiArrowRight
                    aria-hidden
    ...
    >
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          {path.featured && (
            <span className="mt-0.5 block text-[10.5px] font-medium uppercase tracking-[0.12em] text-[#7C3AED]">
              Most popular
            </span>
          )}
        </span>
        ...
        {selected && (
          <span className="grid size-5 shrink-0 place-items-center rounded-full bg-gradient-to-br from-[#2563EB] to-[#7C3AED]">
