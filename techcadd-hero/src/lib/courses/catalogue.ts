...
export const COURSES: Course[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    shortDescription:
      "MongoDB, Express, React and Node — one language end to end, from first component to a deployed full stack application.",
    overview:
      "Start your full-stack career with structured MERN training in Hoshiarpur. You build modern web applications with MongoDB, Express.js, React.js and Node.js, alongside JavaScript, REST APIs, databases and real project work. Designed to take beginners through to industry-ready: the track starts at web fundamentals and finishes with a complete, authenticated, deployed application.",
    category: "Web Development",
    badge: "Trending",
    level: "Intermediate",
    duration: "5 Months",
    ...
    video: {
      ...
      caption:
        "Watch. Learn. Build. See what the training looks like in practice — learners working with modern web technologies and building applications end to end.",
    },
    rating: { score: 4.9, count: 168 },
    audience: [
      {
        label: "Students & freshers",
        copy: "Kick-start your web development career by learning JavaScript, React, Node.js and database concepts through coding.",
      },
      {
        label: "BCA & MCA students",
        copy: "Sharpen your development skills by building with MERN technologies and real projects.",
      },
      {
        label: "Aspiring web developers",
        copy: "Learn frontend and backend together and build complete, dynamic web applications.",
      },
      {
        label: "IT career shifters",
        copy: "Move into the IT industry with practical full-stack skills in current technologies.",
      },
      {
        label: "JavaScript enthusiasts",
        copy: "Extend your JavaScript across frontend, backend, APIs and database-driven applications.",
      },
    ],
    whyChooseUs: [
      {
        title: "Full stack, step by step",
        copy: "Begin with web development fundamentals and progress through frontend and backend with MongoDB, Express.js, React and Node.js.",
      },
      {
        title: "Coding and development in practice",
        copy: "Write code, build components, create APIs, connect databases and ship full stack applications rather than working from theory.",
      },
      {
        title: "Industry-relevant MERN technologies",
        copy: "Work hands-on with MongoDB, Express.js, React, Node.js, JavaScript, REST APIs, Git and GitHub.",
      },
      {
        title: "Real-world projects",
        copy: "Build frontend and full stack projects that show how modern applications work, and that belong in your portfolio.",
      },
      {
        title: "Practical learning & technical support",
        copy: "Coding sessions, development sessions, worked examples, debugging and doubt solving.",
      },
      {
        title: "Full stack training for your career",
        copy: "Build the skills internships, interviews, freelancing and software development roles actually ask for.",
      },
    ],
    modules: [
      {
    ...
    instructor: {
      ...
      intro:
        "The stack only clicks when one language carries you from a button click to a database write. The sessions are built around that path, so every concept lands attached to an application you are already running.",
      points: [
        {
    ...
    relatedCourses: ["full-stack-web-development", "web-development", "java-programming", "data-analytics"],
    keywords: [
      "best mern stack training in hoshiarpur",
      "mern stack course in hoshiarpur",
      "mern certification courses",
      "react node mongodb training",
      "full stack javascript classes",
    ],
  },
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    relatedCourses: ["web-designing", "web-development", "data-analytics", "full-stack-web-development"],
    keywords: [
